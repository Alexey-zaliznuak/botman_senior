...
class Settings(BaseSettings):
    ...
    COMMANDS: List[BaseCommand | GuideCommand] = sorted([
        ...
        GuideCommand(
            ...
            Платные тарифы вы настраиваете сами, они не имеют ограничений по функционалу(кроме рассылок). Но ограничены количеством подписчиков, исключение - безлимитный тариф.
